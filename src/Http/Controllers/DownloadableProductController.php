...
use BagistoPackages\Shop\Repositories\DownloadableLinkPurchasedRepository;
...
class DownloadableProductController extends Controller
{
     ...
     * @return void
     */
    public function __construct(DownloadableLinkPurchasedRepository $downloadableLinkPurchasedRepository)
    {
