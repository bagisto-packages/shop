...
use BagistoPackages\Shop\Models\CmsPageTranslationProxy;
...
class CmsRepository extends Repository
{
    ...
    function model()
    {
        return 'BagistoPackages\Shop\Contracts\CmsPage';
    }
     ...
     *
     * @param string $urlKey
     * @return \BagistoPackages\Shop\Contracts\CmsPage|\Exception
     */
