    ...
    <div class="footer-content">
        <div class="footer-list-container">
            ...
            @php
                ...
                foreach (app('BagistoPackages\Shop\Repositories\CategoryRepository')->getVisibleCategoryTree(core()->getCurrentChannel()->root_category_id) as $category){
                    if ($category->slug)
            ...
            <div class="list-container">
                ...
                <div class="form-container">
                    <div class="control-group">
                        <select class="control locale-switcher" id="locale-switcher"
                ...
                <div class="currency">
                    ...
                    <div class="form-container">
                        <div class="control-group">
                            <select class="control locale-switcher" id="currency-switcher"
                                    onchange="window.location.href = this.value">
