    ...
    <div class="account-content">
        ...
        <div class="account-layout">
            ...
            <div class="account-head mb-10">
                <span class="back-icon"><a href="{{ route('shop.customer.profile.index') }}"><i
                ...
                <div class="edit-form">
                    ...
                    <div class="control-group" :class="[errors.has('gender') ? 'has-error' : '']">
                        ...
                        <select name="gender" class="control" v-validate="'required'"
                            ...
                            <option value="Other"
                                    @if ($customer->gender == "Other") selected @endif>{{ __('shop::app.customer.account.profile.other') }}</option>
                            <option value="Male"
                                    @if ($customer->gender == "Male") selected @endif>{{ __('shop::app.customer.account.profile.male') }}</option>
                            <option value="Female"
                                    @if ($customer->gender == "Female") selected @endif>{{ __('shop::app.customer.account.profile.female') }}</option>
                        </select>
                    ...
                    <div class="control-group" :class="[errors.has('password') ? 'has-error' : '']">
                        ...
                        <input type="password" id="password" class="control" name="password" ref="password"
                    ...
                    <div class="control-group" :class="[errors.has('password_confirmation') ? 'has-error' : '']">
                        ...
                        <input type="password" id="password_confirmation" class="control" name="password_confirmation"
                    ...
                    <div class="button-group">
                        <input class="btn btn-primary btn-lg" type="submit"
                               value="{{ __('shop::app.customer.account.profile.submit') }}">
                    </div>
                </div>
