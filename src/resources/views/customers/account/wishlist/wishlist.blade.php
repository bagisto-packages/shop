...
@section('content-wrapper')
    <div class="account-content">
        @inject ('productImageHelper', 'BagistoPackages\Shop\Helpers\ProductImage')

        @include('shop::customers.account.partials.sidemenu')

        @inject ('reviewHelper', 'BagistoPackages\Shop\Helpers\Review')
            ...
            <div class="account-head mb-15">
                ...
                @if (count($items))
                    <div class="account-action">
                        <a href="{{ route('shop.customer.wishlist.removeall') }}">{{ __('shop::app.customer.account.wishlist.deleteall') }}</a>
                    </div>
                @endif
                    ...
                    @foreach ($items as $item)
                        <div class="account-item-card mt-15 mb-15">
                            ...
                            <div class="operations">
                                <a class="mb-50" href="{{ route('shop.customer.wishlist.remove', $item->id) }}">
                                    <span class="icon trash-icon"></span>
                                </a>

                                <a href="{{ route('shop.customer.wishlist.move', $item->id) }}"
