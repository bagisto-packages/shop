    ...
    <div class="account-content">
        ...
        <div class="account-layout">
            <div class="account-head mb-15">
                <span class="back-icon"><a href="{{ route('shop.customer.address.index') }}"><i
            ...
            <form id="customer-address-form" method="post" action="{{ route('shop.customer.address.store') }}"
                ...
                <div class="account-table-content">
                    ...
                    <div class="control-group" :class="[errors.has('company_name') ? 'has-error' : '']">
                        ...
                        <input value="{{ old('company_name') }}" type="text" class="control" name="company_name"
                    ...
                    <div class="control-group" :class="[errors.has('first_name') ? 'has-error' : '']">
                        ...
                        <input value="{{ old('first_name') }}" type="text" class="control" name="first_name"
                               v-validate="'required'"
                    ...
                    <div class="control-group" :class="[errors.has('last_name') ? 'has-error' : '']">
                        ...
                        <input value="{{ old('last_name') }}" type="text" class="control" name="last_name"
                               v-validate="'required'"
                    ...
                    <div class="control-group" :class="[errors.has('vat_id') ? 'has-error' : '']">
                        <label for="vat_id">{{ __('shop::app.customer.account.address.create.vat_id') }}
                            <span
                                class="help-note">{{ __('shop::app.customer.account.address.create.vat_help_note') }}</span>
                        </label>
                    ...
                    <div class="control-group" :class="[errors.has('address1[]') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="address1[]" value="{{ old('address1') }}" id="address1"
                               v-validate="'required'"
                    ...
                    <div class="control-group" :class="[errors.has('city') ? 'has-error' : '']">
                        ...
                        <input value="{{ old('city') }}" type="text" class="control" name="city" v-validate="'required'"
                    ...
                    <div class="control-group" :class="[errors.has('postcode') ? 'has-error' : '']">
                        ...
                        <input value="{{ old('postcode') }}" type="text" class="control" name="postcode"
                               v-validate="'required'"
                    ...
                    <div class="control-group" :class="[errors.has('phone') ? 'has-error' : '']">
                        ...
                        <input value="{{ old('phone') }}" type="text" class="control" name="phone"
                               v-validate="'required'"
                    ...
                    <div class="button-group">
                        <input class="btn btn-primary btn-lg" type="submit"
                               value="{{ __('shop::app.customer.account.address.create.submit') }}">
