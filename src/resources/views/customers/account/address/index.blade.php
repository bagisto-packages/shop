        ...
        <div class="account-layout">
            <div class="account-head">
                ...
                @if (! $addresses->isEmpty())
                    ...
                    <a href="{{ route('shop.customer.address.create') }}">{{ __('shop::app.customer.account.address.index.add') }}</a>
                </span>
                @else
                    <span></span>
                @endif
                        ...
                        @foreach ($addresses as $address)
                            <div class="address-card">
                                <div class="details">
                                    ...
                                    <span>
                                        <a href="{{ route('shop.customer.address.edit', $address->id) }}">
                                            {{ __('shop::app.customer.account.address.index.edit') }}
                                        </a>
                                    </span>

                                        <span>
                                        <a href="{{ route('shop.address.delete', $address->id) }}"
