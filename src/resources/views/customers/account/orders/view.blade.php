    ...
    <div class="account-content">
        ...
        <div class="account-layout">
            <div class="account-head">
                ...
                @if ($order->canCancel())
                    <a href="{{ route('shop.customer.orders.cancel', $order->id) }}" class="btn btn-lg btn-primary"
                       v-alert:message="'{{ __('shop::app.customer.account.order.view.cancel-confirm-msg') }}'"
                       style="float: right;">
                            ...
                            @foreach ($order->invoices as $invoice)
                                ...
                                <div class="sale-section">
                                    <div class="secton-title">
                                        ...
                                        <a href="{{ route('shop.customer.orders.print', $invoice->id) }}"
                                           class="pull-right">
                        ...
                        <div class="order-box-container">
                            ...
                            <div class="box">
                                ...
                                <div class="box-content">
                                    ...
                                    @php $additionalDetails = \BagistoPackages\Shop\Payment::getAdditionalDetails($order->payment->method); @endphp
