            ...
            <div class="product-info">
                ...
                <div class="product-price mt-10">
                    @if ($product->getTypeInstance()->haveSpecialPrice())
                        <span
                            class="pro-price">{{ core()->currency($product->getTypeInstance()->getSpecialPrice()) }}</span>
                    @else
                        <span
                            class="pro-price">{{ core()->currency($product->getTypeInstance()->getMinimalPrice()) }}</span>
                    @endif
                </div>
            </div>
            ...
            <div class="review-form">
                <div class="heading mt-10">
                    ...
                    @if (core()->getConfigData('catalog.products.review.guest_review') || auth()->guard('customer')->check())
                        <a href="{{ route('shop.reviews.create', $product->url_key) }}"
