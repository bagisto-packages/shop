...
@section('seo')
    ...
    @if (core()->getConfigData('catalog.rich_snippets.products.enable'))
        <script type="application/ld+json">
            {{ app('BagistoPackages\Shop\Helpers\SEO')->getProductJsonLd($product) }}
        </script>
    @endif

    @php
        $productBaseImage = app('BagistoPackages\Shop\Helpers\ProductImage')->getProductBaseImage($product);
    @endphp
            ...
            <product-view>
                <div class="form-container">
                    ...
                    <div class="details">
                        ...
                        @include ('shop::products.view.booking', ['product' => $product])
...
@push('scripts')
    ...
    <script type="text/x-template" id="product-view-template">
        <form method="POST" id="product-form" action="{{ route('shop.cart.add', $product->product_id) }}"
