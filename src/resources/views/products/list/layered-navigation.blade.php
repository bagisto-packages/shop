@inject ('attributeRepository', 'BagistoPackages\Shop\Repositories\AttributeRepository')

@inject ('productFlatRepository', 'BagistoPackages\Shop\Repositories\ProductFlatRepository')

@inject ('productRepository', 'BagistoPackages\Shop\Repositories\ProductRepository')
        ...
        <div>
            ...
            <div class="filter-content">
                ...
                <div class="filter-attributes">
                    ...
                    <filter-attribute-item v-for='(attribute, index) in attributes' :attribute="attribute" :key="index"
                                           :index="index" @onFilterAdded="addFilters(attribute.code, $event)"
            ...
            <div class="filter-attributes-content">
                ...
                <ol class="items" v-if="attribute.type != 'price'">
                    <li class="item" v-for='(option, index) in attribute.options'>
                        ...
                        <span class="checkbox">
                            <input type="checkbox" :id="option.id" v-bind:value="option.id" v-model="appliedFilters"
