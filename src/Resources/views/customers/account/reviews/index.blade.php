            ...
            <div class="account-head">
                ...
                @if (count($reviews) > 1)
                    <div class="account-action">
                        <a href="{{ route('shop.customer.review.deleteall') }}">{{ __('shop::app.customer.account.wishlist.deleteall') }}</a>
                    </div>
                @endif
                    ...
                    @foreach ($reviews as $review)
                        <div class="account-item-card mt-15 mb-15">
                            ...
                            <div class="operations">
                                <a class="mb-50" href="{{ route('shop.customer.review.delete', $review->id) }}"><span
