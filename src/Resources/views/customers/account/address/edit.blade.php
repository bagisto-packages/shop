...
@section('content-wrapper')
    <div class="account-content">
        ...
        <div class="account-layout">
            ...
            <form id="customer-address-form" method="post"
                  action="{{ route('shop.customer.address.update', $address->id) }}" @submit.prevent="onSubmit">
                ...
                <div class="account-table-content">
                    ...
                    <div class="control-group" :class="[errors.has('company_name') ? 'has-error' : '']">
                        <label
                            for="company_name">{{ __('shop::app.customer.account.address.edit.company_name') }}</label>
                        <input type="text" value="{{ old('company_name') ?: $address->company_name }}" class="control"
                               name="company_name"
                    ...
                    <div class="control-group" :class="[errors.has('address1[]') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="address1[]" id="address_0" v-validate="'required'"
                        ...
                        <div class="control-group" style="margin-top: -25px;">
                            @for ($i = 1; $i < core()->getConfigData('customer.settings.address.street_lines'); $i++)
                                <input type="text" class="control" name="address1[{{ $i }}]" id="address_{{ $i }}"
                                       value="{{ isset($addresses[$i]) ? $addresses[$i] : '' }}">
                            @endfor
                        </div>
                    @endif
                    ...
                    <div class="control-group" :class="[errors.has('city') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="city" v-validate="'required|regex:^[a-zA-Z \-]*$'"
