@inject ('bookingSlotHelper', 'BagistoPackages\Shop\Helpers\EventTicket')

<div class="booking-info-row">
    <span class="icon bp-slot-icon"></span>
    <span class="title">
        {{ __('shop::app.shop.products.event-on') }}
    </span>
    <span class="value">
...
@push('scripts')
    ...
    <script type="text/x-template" id="event-tickets-template">
        <div class="book-slots">
            <label style="font-weight: 600">{{ __('shop::app.shop.products.book-your-ticket') }}</label>
