            ...
            <ul class="slider-images">
                <li v-for="(image, index) in images" :key="index" v-bind:class="{'show': index==currentIndex}">
                    <a :href="image.slider_path">
                        ...
                        <div class="show-content" v-bind:class="{'show': index==currentIndex}" :key="index"
                             v-html="content[index]"></div>
                    </a>
                </li>
            </ul>
    ...
    methods: {
        ...
        setProps() {
            ...
            if (this.images.length === 0) {
                this.images.push = {'path': 'vendor/packages/shop/assets/images/banner.png'};
            } else {
