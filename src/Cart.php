...
namespace BagistoPackages\Shop;

use Exception;
use Illuminate\Support\Arr;
use BagistoPackages\Shop\Helpers\Tax;
use Illuminate\Support\Facades\Event;
use BagistoPackages\Shop\Facades\Shipping;
use BagistoPackages\Shop\Models\CartAddress;
use BagistoPackages\Shop\Models\CartPayment;
use BagistoPackages\Shop\Models\Cart as CartModel;
use BagistoPackages\Shop\Repositories\CartRepository;
use BagistoPackages\Shop\Repositories\ProductRepository;
use BagistoPackages\Shop\Repositories\TaxCategoryRepository;
use BagistoPackages\Shop\Repositories\CartItemRepository;
use BagistoPackages\Shop\Repositories\WishlistRepository;
use BagistoPackages\Shop\Repositories\CartAddressRepository;
...
class Cart
{
     ...
     *
     * @return Contracts\Customer|bool|\Illuminate\Contracts\Auth\Guard|\Illuminate\Contracts\Auth\StatefulGuard
     */
     ...
     * @param array $data
     *
     * @return Contracts\Cart|string|array
     * @throws Exception
     */
     ...
     *
     * @param array $data
     * @return \BagistoPackages\Shop\Contracts\CartItem|void
     ...
     */
    protected function setItemTaxToZero(\BagistoPackages\Shop\Contracts\CartItem $item): \BagistoPackages\Shop\Contracts\CartItem
    {
        $item->tax_percent = 0;
        $item->tax_amount = 0;
     ...
     *
     * @param \BagistoPackages\Shop\Contracts\WishlistItem $wishlistItem
     * @return bool
     * @throws Exception
     */
     ...
     * @param Contracts\Cart $cart
     */
    private function assignCustomerFields(Contracts\Cart $cart): void
    {
        if ($this->getCurrentCustomer()->check()
     ...
     * @return bool
     */
    private function isCartItemInactive(\BagistoPackages\Shop\Contracts\CartItem $item): bool
    {
