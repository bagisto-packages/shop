...
abstract class AbstractType
{
     ...
     *
     * @var \BagistoPackages\Shop\Contracts\Product
     */
    protected $product;
    ...
    public function update(array $data, $id, $attribute = "id")
    {
        ...
        if ($route !== 'admin.catalog.products.massupdate') {
            ...
            app('BagistoPackages\Shop\Repositories\ProductCustomerGroupPriceRepository')->saveCustomerGroupPrices($data,
                $product);
        }
    ...
    public function haveSpecialPrice($qty = null)
    {
        ...
        $rulePrice = app('BagistoPackages\Shop\Helpers\CatalogRuleProductPrice')->getRulePrice($this->product);
    ...
    public function getCustomerGroupPrice($product, $qty)
    {
        ...
        if (Cart::getCurrentCustomer()->check()) {
            ...
            $customerGroupRepository = app('BagistoPackages\Shop\Repositories\CustomerGroupRepository');
     ...
     * @param \BagistoPackages\Shop\Contracts\CartItem $item
     *
     * @return \BagistoPackages\Shop\Contracts\CartItem|\BagistoPackages\Shop\Contracts\OrderItem|\BagistoPackages\Shop\Contracts\InvoiceItem|\BagistoPackages\Shop\Contracts\ShipmentItem|\BagistoPackages\Shop\Contracts\Wishlist
     */
     ...
     *
     * @param \BagistoPackages\Shop\Contracts\CartItem|\BagistoPackages\Shop\Contracts\CartItem $item
     *
     * @return array
     */
