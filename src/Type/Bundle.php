...
use BagistoPackages\Shop\Repositories\ProductBundleOptionRepository;
use BagistoPackages\Shop\Repositories\ProductBundleOptionProductRepository;
use BagistoPackages\Shop\Helpers\ProductImage;
use BagistoPackages\Shop\Helpers\BundleOption;
...
class Bundle extends AbstractType
{
     ...
     * @param ProductBundleOptionRepository $productBundleOptionRepository
     ...
     * Get product regular minimal price
     *
     * @param \BagistoPackages\Shop\Contracts\ProductBundleOption $option
     * @param bool $minPrice
     * @return array
     */
    ...
    {
        $bundleOption = app('BagistoPackages\Shop\Helpers\BundleOption');
        return $bundleOption->getProductOptions($product);
    }
