...
use BagistoPackages\Shop\Models\ProductFlat;
use Illuminate\Support\Str;
use BagistoPackages\Shop\Models\CartItem as CartItemModel;
...
class Configurable extends AbstractType
{
    ...
    {
        $childProduct = app('BagistoPackages\Shop\Repositories\ProductRepository')->findOneByField('id', $data['selected_configurable_option']);
     ...
     *
     * @param \BagistoPackages\Shop\Contracts\Wishlist|\BagistoPackages\Shop\Contracts\CartItem $item
     * @return array
     * @throws \Prettus\Repository\Exceptions\RepositoryException
     */
    public function getBaseImage($item)
    {
        if ($item instanceof \BagistoPackages\Shop\Contracts\Wishlist) {
            ...
            if ($item instanceof \BagistoPackages\Shop\Contracts\CartItem) {
    ...
    {
        $configurableOption = app('BagistoPackages\Shop\Helpers\ConfigurableOption');
        return $configurableOption->getConfigurationConfig($product);
    }
