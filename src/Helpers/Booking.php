...
use BagistoPackages\Shop\Repositories\BookingProductDefaultSlotRepository;
use BagistoPackages\Shop\Repositories\BookingProductAppointmentSlotRepository;
use BagistoPackages\Shop\Repositories\BookingProductEventTicketRepository;
use BagistoPackages\Shop\Repositories\BookingProductRentalSlotRepository;
use BagistoPackages\Shop\Repositories\BookingProductTableSlotRepository;
...
class Booking
{
    ...
    public function getTodaySlotsHtml($bookingProduct)
    {
        ...
        return count($slots)
            ? implode(' | ', $slots)
            : '<span class="text-danger">' . trans('shop::app.shop.products.closed') . '</span>';
    }
    ...
    public function getCartItemOptions($data)
    {
        ...
        switch ($bookingProduct->type) {
            case 'event':
                ...
                $data['attributes'] = [
                    [
                        'attribute_name' => trans('shop::app.shop.cart.event-ticket'),
                        'option_id' => 0,
                        'option_label' => $ticket->name,
                    ], [
                        'attribute_name' => trans('shop::app.shop.cart.event-from'),
                        'option_id' => 0,
                        'option_label' => Carbon::createFromTimeString($bookingProduct->available_from)->format('d F, Y'),
                    ], [
                        'attribute_name' => trans('shop::app.shop.cart.event-till'),
                        'option_id' => 0,
            ...
            case 'rental':
                ...
                $data['attributes'] = [
                    [
                        'attribute_name' => trans('shop::app.shop.cart.rent-type'),
                        'option_id' => 0,
                        'option_label' => trans('shop::app.shop.cart.' . $rentingType),
                    ], [
                        'attribute_name' => trans('shop::app.shop.cart.rent-from'),
                        'option_id' => 0,
                        'option_label' => $from,
                    ], [
                        'attribute_name' => trans('shop::app.shop.cart.rent-till'),
                        'option_id' => 0,
                        'option_label' => $to,
                    ]
                ];
            ...
            case 'table':
                ...
                $data['attributes'] = [
                    [
                        'attribute_name' => trans('shop::app.shop.cart.booking-from'),
                        'option_id' => 0,
                        'option_label' => Carbon::createFromTimestamp($timestamps[0])->format('d F, Y h:i A'),
                    ], [
                        'attribute_name' => trans('shop::app.shop.cart.booking-till'),
                        'option_id' => 0,
                ...
                if ($data['booking']['note'] != '') {
                    $data['attributes'][2] = [
                        'attribute_name' => trans('shop::app.shop.cart.special-note'),
                        'option_id' => 0,
     ...
     * @return bool
     */
    public function isCartItemInactive(\BagistoPackages\Shop\Contracts\CartItem $item): bool
    {
