...
class Validator
{
     ...
     *
     * @param \BagistoPackages\Shop\Contracts\CartRule|\BagistoPackages\Shop\Contracts\CatalogRule $rule
     * @param \BagistoPackages\Shop\Contracts\Cart|\BagistoPackages\Shop\Contracts\CartItem|\BagistoPackages\Shop\Contracts\Product $entity
     * @return boolean
     */
    public function validate($rule, $entity)
    {
        ...
        foreach ($rule->conditions as $condition) {
            ...
            if ($entity instanceof \BagistoPackages\Shop\Contracts\Cart && strpos($condition['attribute'], 'cart|') === false) {
                continue;
            }
     ...
     * @param \BagistoPackages\Shop\Contracts\CartItem|\BagistoPackages\Shop\Contracts\Product $entity
     * @return boolean
     */
    public function getAttributeValue($condition, $entity)
    {
        ...
        switch (current($chunks)) {
            case 'cart':
                $cart = $entity instanceof \BagistoPackages\Shop\Contracts\Cart ? $entity : $entity->cart;
     ...
     *
     * @param array $condition
     * @param \BagistoPackages\Shop\Contracts\CartItem $entity
     * @return bool
     */
     ...
     * @param \BagistoPackages\Shop\Contracts\Cart|\BagistoPackages\Shop\Contracts\CartItem|\BagistoPackages\Shop\Contracts\Product $item
     * @return array
     */
