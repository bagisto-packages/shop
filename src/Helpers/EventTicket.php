...
class EventTicket extends Booking
{
    ...
    public function formatPrice($tickets)
    {
        foreach ($tickets as $index => $ticket) {
            ...
            $tickets[$index]['formated_price_text'] = __('shop::app.shop.products.per-ticket-price', ['price' => $formatedPrice]);
        }
     ...
     *
     * @param \BagistoPackages\Shop\Models\CartItem $item
     *
     * @return \BagistoPackages\Shop\Datatypes\CartItemValidationResult
     */
