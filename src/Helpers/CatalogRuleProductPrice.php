...
use Carbon\Carbon;
use BagistoPackages\Shop\Repositories\CatalogRuleProductPriceRepository;
...
class CatalogRuleProductPrice
{
     ...
     *
     * @return \BagistoPackages\Shop\Contracts\Customer|bool|\Illuminate\Contracts\Auth\Guard|\Illuminate\Contracts\Auth\StatefulGuard
     */
     ...
     *
     * @param array $rule
     * @param \BagistoPackages\Shop\Contracts\Product|null $productData
     * @return float
     */
